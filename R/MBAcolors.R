...
exhibits <- list(
  ...
  mba3 = rbind(c('#1B9E77','#6BA4AF', '#E5C200', '#AA9DB5','#6C2D1C', '#EE69AD','#E7A070','#E7298A'),c(1,2,3,4,5,6,7,8)),
  kelp = rbind(c('#FFDD00', '#D48321','#325B1E', '#004B4F', '#007999', '#00CBBD'), c(1, 2, 6, 4, 5, 3)),
  rosa = rbind(c('#90898C', '#B0A39E', '#8B7B72', '#59504D', '#29211D','#171618'),c(1,2,3,4,5,6)),
